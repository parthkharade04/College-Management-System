...
//  Roll no
      ...
      labelrollno=new JLabel("1211 "+first4);
...
//  Branch
      ...
      String branch[]={"Computer ","Mechanical","IT","ENTC","Chemical","Instrumentation"}; 
...
//  Cancel Button 
    ...
    if(ae.getSource()==submit){
       ...
       try{
       String query="insert into student values('"+name+"','"+fname+"','"+rollno+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+classX+"','"+classXII+"','"+aadhar+"','"+course+"','"+branch+"') ";
